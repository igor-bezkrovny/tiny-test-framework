...
var _baseOperator = require('./baseOperator');

var BeGreaterThanOperator = (function (_BaseOperator) {
	_inherits(BeGreaterThanOperator, _BaseOperator);

	function BeGreaterThanOperator() {
		_classCallCheck(this, BeGreaterThanOperator);

		_get(Object.getPrototypeOf(BeGreaterThanOperator.prototype), 'constructor', this).apply(this, arguments);
	}
...
//# sourceMappingURL=beGreaterThanOperator.js.map